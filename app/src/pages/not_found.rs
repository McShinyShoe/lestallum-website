...
pub fn NotFoundPage() -> impl IntoView {
    view! {
        <Title text="404 — Lestallum Town"/>
        <div class="flex min-h-screen flex-col items-center justify-center bg-base-100 px-6 text-center">
            <p class="mb-2 text-sm uppercase tracking-[0.4em] text-emerald-300/80">"Lost?"</p>
            ...
            <p class="mt-6 max-w-md text-lg text-base-content/60">
                "This page doesn't exist in Lestallum — or anywhere else."
            </p>
